...
//import com.sym.demo.pachong.UserCartReptileVo;
...
//    // 小红书正则 https://www.xiaohongshu.com/user/profile/5582768dc2bdeb57d2329fe2
//    // 小红书若是没有爬到数据 说明被验证拦截，  需要用这个地址去浏览器上滑动验证一下再次获取才能好
...
//    private static final String hs_gender_regex = "\"gender\"\\:(.*?)\\,\"id";
//
//    // 微博正则 https://www.weibo.com/sephirex?is_all=1#1624414618836
...
//    private static final String bili_username_regex = "<title>(.*?)的个人空间";
//    private static final String bili_head_regex = "link rel=\"apple-touch-icon\" href=\"(.*?)\"><";
//    private static String bili_location_url = "https://api.bilibili.com/x/relation/stat?vmid=%s&jsonp=jsonp";
//
...
//
//    // 大众点评抓取 https://m.dianping.com/userprofile/16
//    private static final String dazhong_userinfo_regex = "Owl\\.addLog\\(\\'(.*?)\\'\\)";
//    private static final String dazhong_nickname_regex = "nickName = \"(.*?)\"  ";
//    private static final String dazhong_gender_regex = "\"gender\"\\:(.*?)\\,\"";
//
//
//    // 西瓜视频抓取 https://www.ixigua.com/home/69971405180095/?video_card_type=shortvideo
...
//
//        // 性别
//        Pattern genderCompile = Pattern.compile(hs_gender_regex);
//        Matcher genderMatcher = genderCompile.matcher(html);
//        while (genderMatcher.find()) {
//            result.setGender(Integer.valueOf(genderMatcher.group(1)));
//        }
//
//        return result;
//    }
...
//
//        // 粉丝
//        String locationUrl = String.format(bili_location_url, url.substring(27));
//        JSONObject response = JSONObject.parseObject(cn.hutool.http.HttpUtil.get(locationUrl));
//        if (response.getString("code").equals("0")) {
//            System.out.println(response.getJSONObject("data").getString("follower"));
//            result.setFansNum(response.getJSONObject("data").getString("follower"));
//        }
//
//        // 头像
...
//     * @Date: 2021/6/2
//     */
//    public static UserCartReptileVo getKuaishou(String url, String cookieStr) throws Exception {
//        UserCartReptileVo result = new UserCartReptileVo();
//
//        final String locationUrl = getKuaishouLocationUrl(url, cookieStr);
//        String html = HttpUtil.post("https://video.kuaishou.com/graphql",
//                String.format("{\"operationName\":\"visionProfile\",\"variables\":{\"userId\":\"%s\"},\"query\":\"query visionProfile($userId: String) {\\n  visionProfile(userId: $userId) {\\n    result\\n    hostName\\n    userProfile {\\n      ownerCount {\\n        fan\\n        photo\\n        follow\\n        photo_public\\n        __typename\\n      }\\n      profile {\\n        gender\\n        user_name\\n        user_id\\n        headurl\\n        user_text\\n        user_profile_bg_url\\n        __typename\\n      }\\n      isFollowing\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\"}", ReUtil.get("user/(\\S+)\\?", locationUrl, 1)),
//                new BasicHeader[]{
//                        new BasicHeader("Connection", "keep-alive"),
//                        new BasicHeader("Pragma", "no-cache"),
//                        new BasicHeader("Cache-Control", "no-cache"),
//                        new BasicHeader("sec-ch-ua", "\" Not;A Brand\";v=\"99\", \"Google Chrome\";v=\"91\", \"Chromium\";v=\"91\""),
//                        new BasicHeader("accept", "*/*"),
//                        new BasicHeader("sec-ch-ua-mobile", "?0"),
//                        new BasicHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.106 Safari/537.36"),
//                        new BasicHeader("content-type", "application/json"),
//                        new BasicHeader("Origin", "https://video.kuaishou.com"),
//                        new BasicHeader("Sec-Fetch-Site", "same-origin"),
//                        new BasicHeader("Sec-Fetch-Mode", "cors"),
//                        new BasicHeader("Sec-Fetch-Dest", "empty"),
//                        new BasicHeader("Referer", "https://video.kuaishou.com/profile/3xpisbn8du3affa"),
//                        new BasicHeader("Accept-Language", "zh-CN,zh;q=0.9"),
//                        new BasicHeader("Cookie", cookieStr)
//                });
//
//        JSONObject responseData = JSONObject.parseObject(html);
//        if (ObjectUtil.isNotNull(responseData.getJSONObject("data"))) {
//            JSONObject profile = responseData.getJSONObject("data")
//                    .getJSONObject("visionProfile")
//                    .getJSONObject("userProfile")
//                    .getJSONObject("profile");
//            result.setNickName(profile.getString("user_name"));
//
//            // 头像
//            result.setHeadImgUrl(profile.getString("headurl"));
//
//            JSONObject ownerCount = responseData.getJSONObject("data")
//                    .getJSONObject("visionProfile")
//                    .getJSONObject("userProfile")
//                    .getJSONObject("ownerCount");
//
//            // 粉丝
//            result.setFansNum(ownerCount.getString("fan"));
//        }
//
//
//        return result;
...
//            result.setHeadImgUrl(headImgUrl);
//            result.setFansNum(StringUtils.isNotEmpty(fans) ? fans : "0");
//
//        }
//
...
//
//        // 性别
//        Pattern genderCompile = Pattern.compile(dazhong_gender_regex);
//        Matcher genderMatcher = genderCompile.matcher(html);
//        while (genderMatcher.find()) {
//            result.setGender(genderMatcher.group(1).equals("男") ? 1 : 2);
//        }
//        return result;
//    }
//
...
//
//    /**
//     * @Description: 获取快手重定向地址
//     * @Param: [url]
//     * @return: java.lang.String
//     * @Author: sym
//     * @Date: 2021/6/18
//     */
//    private static String getKuaishouLocationUrl(String url, String cookie) throws Exception {
//        URI uri = new URI(url);
...
//        urlConnection.setRequestProperty("Referer", "https://video.kuaishou.com");
//        urlConnection.setRequestProperty("Origin", "https://live.kuaishou.com/");
